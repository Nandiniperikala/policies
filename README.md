...
To build the final jar and optimize the policies application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v7.10.0/microservices-architecture/#jhipster-registry
